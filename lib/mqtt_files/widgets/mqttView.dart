...
import 'package:dashboard/mqtt_files/mqtt/MQTTManager.dart';
import 'package:dashboard/mqtt_files/mqtt/state/MQTTAppState.dart';
    ...
    return Padding(
      ...
      child: Column(
        children: <Widget>[
          ...
          _buildTextFieldWith(
              _usernameController, 'Enter Username', currentAppState.getAppConnectionState),
          _buildTextFieldWith(
              _passwordController, 'Enter Password', currentAppState.getAppConnectionState),
          const SizedBox(height: 10),
  ...
  Widget _buildTextFieldWith(TextEditingController controller, String hintText,
    ...
    if (controller == _messageTextController &&
      ...
      shouldEnable = true;
        ...
        ||(controller == _usernameController && state == MQTTAppConnectionState.disconnected) || (controller == _passwordController &&
        state == MQTTAppConnectionState.disconnected)
    )
    {
      shouldEnable = true;
